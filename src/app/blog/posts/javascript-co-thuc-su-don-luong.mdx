...
- Callstack: Một stack các function được gọi. Khi môt function được gọi, nó sẽ được xếp vào đây, và sẽ hoạt động theo nguyên tắc LIFO
...
Theo lý thuyết, công việc đếm thời gian kia mất 0s cho trợ lý thực hiện, rồi ông đầu bếp sẽ in ra delay. Cùng xem kết quả thực tế nhé:
